...
input[1]=document.getElementById('computerId');
input[2]=document.getElementById('date');
input[3]=document.getElementById('hours');
input[4]=document.getElementById('time');
var containerError = new Array("passengerIdError","computerIdError","dateError","hoursError","timeError");
function checkForm(){
  //kiểm tra dữ liệu rỗng
  var data = new Array();
  data[0]=document.getElementById('passengerId').value;
  data[1]=document.getElementById('computerId').value;
  ...
  myError[1] = "<span style='color:red,font-weight:bold'>Please fill out computer id</span>";
