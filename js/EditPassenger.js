...
input[1]=document.getElementById('address');
input[2]=document.getElementById('phone');
input[3]=document.getElementById('email');

var containerError = new Array("nameError","addressError","phoneError","emailError");
...
//   myError[0] = "<span style='color:red,font-weight:bold'>Please fill out passenger id</span>";
  myError[0] = "<span style='color:red,font-weight:bold'>Please fill out passenger name</span>";
  myError[1] = "<span style='color:red,font-weight:bold'>Please fill out passenger address</span>";
  myError[2] = "<span style='color:red,font-weight:bold'>Please fill out passenger phone</span>";
  myError[3] = "<span style='color:red,font-weight:bold'>Please fill out passenger email</span>";
  var check =0;
//   var regexId=/^P[0-9]{3}/;
...
// }
//kiểm tra email
if(!(data[3].match(regexEmail)) && data[3]!=""){
    document.getElementById(containerError[3]).innerHTML="Email must be in date format (abc@xyz.def...).!";
    check =1;
}
//kiểm tra sdt
if(data[2].length!=10 && data[2]!=""){
    document.getElementById(containerError[2]).innerHTML="phone number must consist of 10 digits!";
    check =1;
}
  if(check == 1){
      return false;
